    ...
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-12 d-flex align-items-center">
                ...
                <div class="ml-auto text-right">
                    <strong>Fecha/Hora:</strong> {{ $invoice_date }}
                </div>
            </div>
        </div>
        ...
        <div class="row invoice-info mt-3 mb-4">
            ...
            <div class="col-sm-4 text-right">
				...
				<?php 
					$today = new DateTime();
				if(isset($customBillingDate) && !empty($customBillingDate)){
					
					$formatted = DateTime::createFromFormat('Y-m-d', $customBillingDate)
    ->format('M d, Y');
				}else{
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                ...
                <p class="text-muted">
                    ...
                    <strong>Punto Red:</strong> Depósito Bancamia 901378346
                </p>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="summary-box">
					...
					<?php if(isset($custom_amount) && !empty($custom_amount)){ ?>	
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>${{ number_format($amountToPay-$totalPaid, 2) }}</td>
                        </tr>
                    </table>
					<?php }else{ ?>
					 <table class="table table-borderless">
